 ...
 * Handles persistent storage and retrieval of account data in a MySQL database.
 */
public class AccountDAOImpl implements AccountDAO {
    ...
    public boolean createAccount(Account account) {
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            System.err.println("Unexpected Error in AccountDAOImpl.createAccount: " + e.getMessage());
        }
        return false;
    }
    ...
    public Optional<Account> getAccountById(int accountId, int pin) {
        String sql = """
            SELECT account_id, holder_name, balance, created_at
            FROM accounts
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            System.err.println("SQL Error (getAccountById): " + e.getMessage());
        } catch (Exception e) {
            System.err.println("Unexpected Error in AccountDAOImpl.getAccountById: " + e.getMessage());
        }
    ...
    public boolean updateBalance(int accountId, int amount, int pin) {
        String sql = "UPDATE accounts SET balance = ? WHERE account_id = ? AND pin = ?";
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            System.err.println("SQL Error (updateBalance): " + e.getMessage());
        } catch (Exception e) {
            System.err.println("Unexpected Error in AccountDAOImpl.updateBalance: " + e.getMessage());
        }
        return false;
    }

    @Override
    public boolean transfer(int senderId, int receiverId, int amount, int pin) {
        String withdrawSql = "UPDATE accounts SET balance = balance - ? WHERE account_id = ? AND pin = ? AND balance >= ?";
        ...
        try {
            ...
            try (PreparedStatement psWithdraw = connection.prepareStatement(withdrawSql);
                 PreparedStatement psDeposit = connection.prepareStatement(depositSql)) {
            ...
            System.err.println("SQL Error (transfer): " + e.getMessage());
        } catch (Exception e) {
            System.err.println("Unexpected Error in AccountDAOImpl.transfer: " + e.getMessage());
        }
        return false;
    }
}
